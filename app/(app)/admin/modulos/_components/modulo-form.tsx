...
export function ModuloForm({
  ...
  const form = useForm<CrearModuloFormData | EditarModuloFormData>({
    resolver: zodResolver(isEditing ? editarModuloSchema : crearModuloSchema),
  ...
  // Resetear el formulario cuando cambia el módulo (para editar)
  useEffect(() => {
    if (modulo) {
      form.reset({
        codigo: modulo.codigo,
